...
public class Tests {
    ...
    public void testSimplePolygon() {
        ...
        //List ArrayList<Point> Vertex = polygon.Vertexes();
        // Point is inside
    ...
    public void testCenterPoint() {
      ...
      Polygon polygon = Polygon.Builder()
              .addVertex(new Point(0, 0))
              .addVertex(new Point(0, 3))
              .addVertex(new Point(3, 3))
              .addVertex(new Point(3, 0))
              .build();

      Point centerPt = polygon.centerPoint();
      boolean temp = false;

      if(centerPt.getX() == 1.5 && centerPt.getY() == 0.9) temp = true;
      // center point is accurate
